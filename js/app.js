...
var showAnswerers = function(answerers) {
 	...
 	// Set the username properties in result
 	var answerersElem = result.find('.username-text');
 	answerersElem.text(answerers.display_name);
 	...
 	// asker.html('<p>Name: <a target="_blank" '+
 	// 	'href=http://stackoverflow.com/users/' + answerers.user_id + ' >' +
 	// 	answerers.display_name +
 	// 	'</a></p>' +
 	// 	'<p>Reputation: ' + question.owner.reputation + '</p>'
 	// );
